 ...
 * @return {?}
 */
function PQ(keepData) {
    var match = keepData.split("OneTab");
    /** @type {Element} */
    var ret = document.createElement("span");
    var key;
    for (key in match) {
...
var R = function(er) {
    /** @type {(HTMLElement|null)} */
    var r = document.getElementById("contentDiv");
    /**
     * @param {string} key
     ...
     * @return {?}
     */
    var fn = function(key, opt_attributes, outstandingDataSize, first) {
        /** @type {Element} */
        var div = document.createElement("div");
        /** @type {string} */
        div.style.whiteSpace = "pre";
        /** @type {string} */
        div.style.paddingBottom = outstandingDataSize + "px";
        /** @type {string} */
        div.style.fontSize = opt_attributes + "px";
        /** @type {string} */
        div.style.textAlign = "right";
        /** @type {string} */
        div.className = "clickable";
        div.appendChild(PQ(key));
        /**
         * @param {?} e
         * @return {undefined}
         */
    ...
    r.appendChild(fn("Display OneTab", 13, 8, function() {
        TV();
    }));
    r.appendChild(fn("Send all tabs from this window to OneTab", 13, 8, function() {
        cV();
    }));
    r.appendChild(fn("Send current tab to OneTab", 13, 8, function() {
        _Q();
    }));
    r.appendChild(fn("Send tabs on the right to OneTab", 13, 8, function() {
        zV();
    }));
    r.appendChild(fn("Send all tabs from all windows to OneTab", 13, 12, function() {
        tQ();
    }));
    r.appendChild(fn("Settings", 12, 0, function() {
        tQ();
    }));
};
